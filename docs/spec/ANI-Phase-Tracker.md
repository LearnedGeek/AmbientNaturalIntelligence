...
| **Theme N — Outreach Grounding / Source-Typing of Composed Output** | Theme N (new, May 6) | [`ANI-Theme-N-Outreach-Grounding-Source-Typing-Plan.md`](./ANI-Theme-N-Outreach-Grounding-Source-Typing-Plan.md) | **PLACEHOLDER drafted May 6, 2026 (~17:00 CDT)** in response to Mark's load-bearing framing during diagnosis of two May 6 tagged messages: *"We say it's 'felt care', not 'felt if she makes up something close to care'."* The architectural axis Theme N names: outreach composition currently free-generates from imagination; every guard rail (claim verification, Door B, gate invariants, post-hoc rewriters) sits *downstream* of generation; **none require the generator to originate from a grounded source**. Theme N is the upstream complement — composition-side mechanism that picks ONE source-type as primary anchor and frames against it. **Source-typing, not source-restriction**: outreach can draw from {shared-experience / Ani's-canonical-world / Ani's-interior / Ani's-perception}; confab is type-3 interior content presented with type-1 shared framing; diversity preserved via honest type-3 framing. **Convergent with Theme M, not redundant**: Theme M ships slices as available context; Theme N makes outreach pick one as required anchor. **Six months of prior thinking surfaced via claude-recall** — Bob Swanson cascade (Mar 6), Mark's shareable-vs-private framing (Mar 6), Nature Grounding deployment (Mar 14, precedent), April 2 GROUNDED/UNGROUNDED data-flow analysis, April 21 cascade. Theme N's job is consolidating these into one coherent workstream. **Three mechanism shapes on the table (N-A source-attached / N-B two-stage / N-C refuse-when-thin); deliberately not locked tonight**. **Paper 3 contribution candidate**: *"Source-typed outreach grounding as architectural prerequisite for felt care in companion AI."* Strengthens the Paper 2 hold case. Pending: Mark's morning read; mechanism choice; full phased plan draft. |
