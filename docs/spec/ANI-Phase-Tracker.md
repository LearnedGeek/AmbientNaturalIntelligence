...
| **Paper 2 Editorial Finalization → Zenodo + arXiv** | Research | see *Research Papers* section below | **RELEASE HOLD SCOPE REVISED — Mark May 4, 21:36 CDT.** Draft 0.39 is content-complete. The original May 4 20:45 hold-decision was *"hold until runtime is recovered to defend assertions."* The revised scope per Theme M plan §10.4 is *"hold until three small framing-additions land that route the substrate-exhaustion finding to Paper 3 + Theme M as the architectural answer."* The substantive body of Paper 2's findings (§5.15, §5.17, §6.13, §6.14, §5.18, §5.24, §6.10) does not move — those report historical observations made at specific moments and are not retroactively invalidated by May 3–4 unusability. Three small edits route the new finding cleanly: §6.17 (~50 words naming Theme M / Layer 6 as the architectural response), §7.2 (~80 words appending that the architectural-response items are load-bearing for sustained conversation, not just deferred measurement), and optional §7.1 (third autoethnographic worked instance — May 4 publication-discipline decision). With those edits, Paper 2 ships on its own terms; Paper 3 + Theme M absorb the unusability finding. **Sequencing per Theme M plan §10.5**: (1) Mark greenlights Theme M plan; (2) Apply §6.17 + §7.2 small edits; (3) Fresh read-pass on revised sections; (4) Ship to Zenodo + arXiv; (5) Theme M M.0 begins. Steps 2–4 are short — possibly same-day with Mark's morning read. **Mark's framing (21:36 CDT)**: *"I have a sneaky feeling that the paper 2 updates won't be as extensive as we first thought, and given that we're setting up now for paper 3, we can rest a little easier and perhaps with small updates paper 2 isn't held up as much as I was worried it was."* That instinct is verified by the §10 review. See `docs/spec/ANI-Theme-M-Conscious-Substrate-Individuation-Plan.md` §10 for the full review + draft edit text. |
