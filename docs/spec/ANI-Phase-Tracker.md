...
|---|---|---|---|
| **Theme J — Guard Consistency Refactor** | Theme J (new) | [`ANI-Theme-J-Guard-Consistency-Refactor-Plan.md`](./ANI-Theme-J-Guard-Consistency-Refactor-Plan.md) | **J.0 baseline instrumentation, J.1 reasoning-pipe strip, and J.2 structured per-speaker conversation summary all shipped Apr 27.** J.2 observation window opens once Mark resumes conversations. J.3 (temporal attribution at retrieval) next. J.4-J.7 (CognitiveOutputGate extraction, producer migration, detector cleanup, Paper 3 contribution writing) sequenced after J.3 observation closes. |
